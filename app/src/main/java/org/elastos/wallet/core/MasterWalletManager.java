...
public class MasterWalletManager {
    ...
    public MasterWalletManager(String rootPath) {
        mRootPath = rootPath;
        mManagerProxy = InitMasterWalletManager(mRootPath);
    }

    public void DisposeNative() {
        Log.i(TAG, "DisposeNative");
        DisposeNative(mManagerProxy);
    }
    ...
    public MasterWallet CreateMasterWallet(
        ...
        long masterProxy = CreateMasterWallet(mManagerProxy, masterWalletId, mnemonic,
    ...
    public ArrayList<MasterWallet> GetAllMasterWallets() throws WalletException {
        ...
        long[] masterWalletProxies = GetAllMasterWallets(mManagerProxy);
    ...
    public String[] GetAllMasterWalletIds() throws WalletException {
        return GetAllMasterWalletIds(mManagerProxy);
    }

    public MasterWallet GetWallet(String masterWalletId) throws WalletException {
        long masterWalletProxy = GetWallet(mManagerProxy, masterWalletId);
    ...
    public void DestroyWallet(String masterWalletId) throws WalletException {
        DestroyWallet(mManagerProxy, masterWalletId);
    }
    ...
    public MasterWallet ImportWalletWithKeystore(
        ...
        long masterProxy = ImportWalletWithKeystore(mManagerProxy, masterWalletId,
    ...
    public MasterWallet ImportWalletWithMnemonic(
        ...
        long masterProxy = ImportWalletWithMnemonic(mManagerProxy, masterWalletId,
    ...
    public String ExportWalletWithKeystore(MasterWallet masterWallet, String backupPassWord,
        ...
        return ExportWalletWithKeystore(mManagerProxy, masterWallet, backupPassWord, payPassword);
    }

    public String ExportWalletWithMnemonic(MasterWallet masterWallet,
                                           String payPassWord) throws WalletException {

        return ExportWalletWithMnemonic(mManagerProxy, masterWallet, payPassWord);
    }

    public String GenerateMnemonic(String language) throws WalletException {
        return GenerateMnemonic(mManagerProxy, language);
    }

    public String GetMultiSignPubKeyWithMnemonic(String phrase, String phrasePassword)
            throws WalletException {

        return GetMultiSignPubKeyWithMnemonic(mManagerProxy, phrase, phrasePassword);
    }

    public String GetMultiSignPubKeyWithPrivKey(String privKey) throws WalletException {
        return GetMultiSignPubKeyWithPrivKey(mManagerProxy, privKey);
    }

    public void SaveConfigs() {
        SaveConfigs(mManagerProxy);
    }
    ...
    public MasterWallet CreateMultiSignMasterWallet(String masterWallet, String coSigners,
        ...
        long masterProxy = CreateMultiSignMasterWallet(mManagerProxy, masterWallet,
    ...
    public MasterWallet CreateMultiSignMasterWallet(
        ...
        long masterProxy = CreateMultiSignMasterWalletWithPrivKey(mManagerProxy, masterWallet,
    ...
    public MasterWallet CreateMultiSignMasterWallet(
        ...
        long masterProxy = CreateMultiSignMasterWalletWithMnemonic(mManagerProxy, masterWalletId,
    ...
    public String EncodeTransactionToString(String txJson) {
        return EncodeTransactionToString(mManagerProxy, txJson);
    }

    public String DecodeTransactionFromString(String cipher) {
        return DecodeTransactionFromString(mManagerProxy, cipher);
    }
